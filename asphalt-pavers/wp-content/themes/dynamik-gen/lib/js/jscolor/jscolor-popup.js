...
var jscolor = {
	...
	detectDir : function() {
		...
		for(var i=0; i<e.length; i++) {
			if(e[i].src && /(^|\/)jscolor-popup\.js([?#].*)?$/i.test(e[i].src)) {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.boxB.className = 'css-builder-element'

			// pad image
			p.pad.style.width = jscolor.images.pad[0]+'px'
			p.pad.style.height = jscolor.images.pad[1]+'px'
			p.pad.className = 'css-builder-element'
			...
			p.padB.className = 'css-builder-element'
			...
			p.padM.className = 'css-builder-element'

			// slider image
			p.sld.style.overflow = 'hidden'
			p.sld.style.width = jscolor.images.sld[0]+'px'
			p.sld.style.height = jscolor.images.sld[1]+'px'
			p.sld.className = 'css-builder-element'
			...
			p.sldB.className = 'css-builder-element'
			...
			p.sldM.className = 'css-builder-element'
		...
		function setPad(e) {
			...
			if(navigator.appName == 'Microsoft Internet Explorer' || navigator.userAgent.indexOf('Firefox')!=-1) {
				var y = posM[1]-posPad[1]-document.documentElement.scrollTop
			} else {
				var y = posM[1]-posPad[1]-document.body.scrollTop
			}
